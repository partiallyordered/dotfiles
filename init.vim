...
-- local workspace_dir = '$XDG_STATE_HOME/nvim-jdtls/workspaces/' .. project_name
local workspace_dir = '/home/msk/.local/state/nvim-jdtls/workspaces/' .. project_name
...
local nvim_jdtls_config = {
  ...
  cmd = {
    ...
    -- 💀
    '-jar', '/nix/store/0kmi2rn1q01a7i65x20sgrpizni754zd-jdt-language-server-1.13.0/share/java/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
    ...
    -- 💀
    '-configuration', '/nix/store/0kmi2rn1q01a7i65x20sgrpizni754zd-jdt-language-server-1.13.0/share/config',
