...
#   curl -L https://raw.githubusercontent.com/NixOS/nixpkgs/6cb5aad76b9bbb6fb61938982d68d3e19e4aa16f/pkgs/development/tools/jdt-language-server/default.nix > jdt-language-server.nix
{ lib
, stdenv
, fetchurl
, makeWrapper
