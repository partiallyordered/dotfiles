# Derived from: https://github.com/NixOS/nixpkgs/blob/136f379799d27963fbb39f80bf607d639846aac5/pkgs/development/web/playwright/driver.nix
# Updated version, checksums (diff against original)
{ lib
, stdenv
, chromium
, ffmpeg
  ...
  driver = stdenv.mkDerivation (finalAttrs:
    ...
    in
    {
      ...
      src = fetchurl {
        ...
        sha256 = {
          x86_64-linux = "180hddf8k7warpsvs696q4508lxsn1rfdpq89lp3368a9h85z5px";
